...
class NannyModel {
    ...
    factory NannyModel.fromJson(Map<String, dynamic> json) => NannyModel(
        ...
        professionalbackgrounds: json["professionalbackgrounds"] == null ? null : Professionalbackgrounds.fromJson(json["professionalbackgrounds"]),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "distance": distance,
        "servicerates": servicerates == null ? [] : List<dynamic>.from(servicerates!.map((x) => x.toJson())),
...
class Preference {
    ...
    Map<String, dynamic> toJson() => {
        "_id": id,
        "nannyId": nannyId,
        "ageGroupsYouWorkWith": ageGroupsYouWorkWith == null ? [] : List<dynamic>.from(ageGroupsYouWorkWith!.map((x) => x)),
        "createdAt": createdAt?.toIso8601String(),
        "serviceYouOffer": serviceYouOffer == null ? [] : List<dynamic>.from(serviceYouOffer!.map((x) => x)),
        "updatedAt": updatedAt?.toIso8601String(),
    };
}
...
class Professionalbackgrounds {
    ...
    factory Professionalbackgrounds.fromRawJson(String str) => Professionalbackgrounds.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory Professionalbackgrounds.fromJson(Map<String, dynamic> json) => Professionalbackgrounds(
        id: json["_id"],
        nannyId: json["nannyId"],
