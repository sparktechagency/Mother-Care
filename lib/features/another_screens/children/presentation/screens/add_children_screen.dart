...
import 'package:mother_care/features/another_screens/children/presentation/controller/add_children_controller.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: Padding(
        ...
        child: CommonButton(titleText: AppString.save),
      ),
    );
  }
}
