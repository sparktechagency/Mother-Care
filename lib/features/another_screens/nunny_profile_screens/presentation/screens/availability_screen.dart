  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<AvailabilityController>(
        ...
        builder: (controller) {
          return controller.isLoading?CommonLoader():   Padding(
                              ...
                              if (item["isOn"] as bool)
                                Row(
                                  children: [
                                    ...
                                    Expanded(
                                      child: CommonTextField(
                                        ...
                                        controller: TextEditingController(
                                          text: item["startTime"] as String,
                                        ),
                                        suffixIcon: PopupMenuButton<String>(
                                          icon: Icon(Icons.keyboard_arrow_down),
                                          color: AppColors.white,
                                          onSelected: (String value) {
                                            controller.setStartTime(index, value);
                                          },
                                          itemBuilder: (context) {
                                            return controller.timesList.map((time) {
                                    ...
                                    CommonText(left: 7, right: 7, text: "to"),
                                    ...
                                    Expanded(
                                      child: CommonTextField(
                                        ...
                                        readOnly: true,
                                        controller: TextEditingController(
                                          text: item["endTime"] as String,
                                        ),
                                        suffixIcon: PopupMenuButton<String>(
                                          icon: Icon(Icons.keyboard_arrow_down),
                                          color: AppColors.white,
                                          onSelected: (String value) {
                                            controller.setEndTime(index, value);
                                          },
                                          itemBuilder: (context) {
                                            return controller.timesList.map((time) {
                                              return PopupMenuItem<String>(
      ...
      bottomNavigationBar:  GetBuilder(
        ...
        builder: (controller) {
          return Padding(
            padding:  EdgeInsets.only(left: 20, right: 20, bottom: 80.h
            ),
            child: CommonButton(
              buttonRadius: 60,
